    ...
    innerHTML: `
      <ul class="footer-development__list">
        <li class="footer-development__item">
          Designer:
          <a href="https://t.me/Mrshmallowww" class="footer-development__link" >Anastasia Ilina</a>
        </li>
        <li class="footer-development__item">
          Developer:
          <a href="https://t.me/DashkevichAS" class="footer-development__link" >Anton Dashkevich</a>
        </li>
      </ul>
    `,
  });
